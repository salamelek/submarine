// submarine code by salamelek

#include <SPI.h>
#include <nRF24L01.h>
#include <RF24.h>

// how much time can the sub go without signal (in seconds)
int emergencyTimeOut = 3;
...
void loop() {
  ...
  if (currentTime - previousTime > emergencyTimeOut * 1000) {
